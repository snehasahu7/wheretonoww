...
const Hero = () => {
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const response = await axios.get("https://wheretonoww-5.onrender.com/api/eventlist", {
  ...
  const handleClose = () => {
    ...
    const testSession = async () => {
        try {
            const response = await axios.get('https://wheretonoww-5.onrender.com/api/test-session', {
                withCredentials: true
            });
    ...
    const handleticket = async () => {
        ...
        try {
            ...
            const response = await axios.post('https://wheretonoww-5.onrender.com/api/storemail', 
                {
                    email,
            ...
            if (response.data.success) {
                ...
                const verifyResponse = await axios.get('https://wheretonoww-5.onrender.com/api/stored-emails', {
                    withCredentials: true
                });
    ...
    const checkStoredEmails = async () => {
        try {
            const response = await axios.get('https://wheretonoww-5.onrender.com/api/stored-emails', {
                withCredentials: true
            });
